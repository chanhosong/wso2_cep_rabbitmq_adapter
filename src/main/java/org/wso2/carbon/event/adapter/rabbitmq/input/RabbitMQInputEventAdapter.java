...
public class RabbitMQInputEventAdapter implements InputEventAdapter {
    ...
    private RabbitMQInputEventAdapterListener rabbitmqAdapterListener;

    public RabbitMQInputEventAdapter(InputEventAdapterConfiguration eventAdapterConfiguration, Map<String, String> globalProperties) {
    ...
    public void init(InputEventAdapterListener eventAdapterListener) {
        ...
        rabbitmqAdapterListener = new RabbitMQInputEventAdapterListener(rabbitMQInputEventAdapterConnectionConfiguration, eventAdapterConfiguration, eventAdapterListener);
    }
